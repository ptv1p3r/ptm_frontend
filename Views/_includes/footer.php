...
<footer class="footer">
    ...
    <div class="footer-copyr wf100">
        <div class="container">
            <div class="row">
                <!--                <div class="col-md-4 col-sm-4"><img src="/images/home/logo.png" alt=""></div>-->
                <div class="col-md-8 col-sm-8">
                    <p> Todos os direitos reservados © 2022, Design & Developed By: EI Ismat </p>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/prettyPhoto/3.1.6/js/jquery.prettyPhoto.js"></script>
