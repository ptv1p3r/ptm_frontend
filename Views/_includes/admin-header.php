...
<head>
    ...
    <!--bootstrap 5.1.3 modif. by sb-admin team-->
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="<?php echo HOME_URL . '/admin/dashboard'; ?>"> <img
                src="<?php echo HOME_URL . '/Images/logo/adoteUma.png'; ?>" alt="Dashboard" width="48"> Project Tree
        Management</a>
    <!-- Navbar-->
